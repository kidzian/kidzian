...
//     <div>
//         <Heading/>
//         <div className=' w-[100vw] h-auto flex gap-1 pl-20 pr-16 pt-12'>
//             <div className=' w-[100vw] flex flex-col items-start justify-center gap-4'>
//                 <h1 className='text-5xl font-bold'>Get In Touch</h1>
//                 <p className='w-[28vw]'>We're here to help.Chat to our friendly team 24/7 and get set up and ready to go in just 5 minutes.</p>

//                 <div>
//                     <h1 className='flex gap-1 items-center text-[#6e2cf6] font-semibold tracking-tighter text-[14px] cursor-pointer'><Send size={15}/>Shoot us an email</h1>
//                     <h1 className='flex gap-1 items-center text-[#6e2cf6] font-semibold tracking-tighter text-[14px] cursor-pointer'> <LinkedinIcon size={15} /> Message us on LinkedIn</h1>
//                 </div>
...
//             <div className='bg-blue-400 w-[100vw] h-[87.5vh]'>
