...
<div className="flex flex-col lg:flex-row w-full min-h-screen items-center justify-center px-6 lg:px-16 py-12 gap-8">
      ...
      <div className='w-full mt-20 h-auto md:h-[60vh] lg:h-[60vh] xl:h-[60vh] 2xl:h-[60vh] flex flex-col items-center justify-start '>
        <h1 className='text-lg font-bold mb-16'>Kidzian is Backed By</h1>

        <div className=' grid-cols-3 w-full items-center justify-center sm:block md:grid lg:grid xl:grid 2xl:grid'>
        <div className='mb-20 md:mb-0 lg:mb-0 xl:mb-0 2xl:mb-0 flex flex-col items-center justify-center'>
