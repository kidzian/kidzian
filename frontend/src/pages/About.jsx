...
import { BicepsFlexed, Cpu, Earth, Gamepad2, MailCheck, Rocket, Send } from 'lucide-react';
...
const About = () => {
  ...
  <div className="flex items-start gap-4">
  <FaStar size={40} className="pb-5 text-[#8b5cf6]" />
    <p className="text-sm text-[#4b5462]">
    ...
    >
      ...
      <div className='w-full h-[60vh] flex flex-col items-center justify-start '>
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <h1 className='font-bold text-lg'>Cheire Blair Foundation For Women</h1>
          <p className='text-[#4b5462] text-sm'>
